...
import { Tabs, Space, SimpleGrid, Card, Title, Text, Progress, Grid, Stack, Group, Button } from "@mantine/core";
...
export default function HomePage() {
  ...
  const tabMap: Record<string, "overview" | "meals" | "recipes" | "history"> = {
    "/home": "overview",
  ...
  const onTabChange = (v: string | null) => {
    if (!v) return;
    navigate(v === "overview" ? "/home" : `/home/${v}`);
  };
